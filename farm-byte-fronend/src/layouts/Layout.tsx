...
const Layout = () => {
    ...
    return (
        <div className="flex flex-row min-h-screen bg-gradient-to-r from-neutral-50 to-neutral-100">
            <div className="hidden md:block">
                <div className="flex flex-row w-screen">
                    <Sidebar/>
                    <div className="flex flex-col w-full">
                        <WebNavbar/>
                        <div className={`min-h-full flex-1 p-10 ${isOpen ? 'ml-72 transition-all ease-linear duration-300' : 'ml-24 transition-all ease-linear duration-300'}`}>
                            <Outlet/>
                        </div>
                    </div>
                </div>

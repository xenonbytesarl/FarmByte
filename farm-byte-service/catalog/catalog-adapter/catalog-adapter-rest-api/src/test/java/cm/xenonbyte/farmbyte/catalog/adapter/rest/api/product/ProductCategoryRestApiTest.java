...
public final class ProductCategoryRestApiTest extends RestApiBeanConfigTest {
    ...
    void should_create_root_or_child_product_category(
        ...
        when(productCategoryDomainServiceApiAdapter.createProductCategory(createProductCategoryViewRequest))
        ...
        verify(productCategoryDomainServiceApiAdapter, times(1))
   ...
   @ParameterizedTest
    ...
    void should_throw_exception_when_create_product_category_fail(
       ...
       verify(productCategoryDomainServiceApiAdapter, times(1)).createProductCategory(createProductCategoryViewRequestArgumentCaptor.capture());
       assertThat(createProductCategoryViewRequestArgumentCaptor.getValue()).isEqualTo(createProductCategoryViewRequest);
   }

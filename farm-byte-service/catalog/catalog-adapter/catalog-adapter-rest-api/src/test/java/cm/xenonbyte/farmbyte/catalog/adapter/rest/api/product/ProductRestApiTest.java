...
public final class ProductRestApiTest extends RestApiBeanConfigTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(productDomainServiceApiAdapter, "rootPathStorageProducts", "products");
    }
    ...
    void should_create_product() throws Exception {
        ...
        when(productDomainServiceApiAdapter.createProduct(createProductViewRequest, imageMultipartFile)).thenReturn(createProductViewResponse);
        ...
        verify(productDomainServiceApiAdapter, times(1)).createProduct(createProductViewRequestArgumentCaptor.capture(), mockMultipartFileArgumentCaptor.capture());
    ...
    void should_throw_exception_when_create_product_with_existing_name() throws Exception {
        ...
        when(productDomainServiceApiAdapter.createProduct(createProductViewRequest, imageMultipartFile))

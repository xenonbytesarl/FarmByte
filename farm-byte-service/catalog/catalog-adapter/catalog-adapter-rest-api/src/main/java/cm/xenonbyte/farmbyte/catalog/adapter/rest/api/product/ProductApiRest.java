 ...
 */
@RestController
public class ProductApiRest implements ProductsApi {

    public static final String PRODUCT_CREATED_SUCCESSFULLY = "ProductApiRest.1";

    private final ProductApiAdapterService productApiAdapterService;

    public ProductApiRest(@Nonnull ProductApiAdapterService productApiAdapterService) {
        this.productApiAdapterService = Objects.requireNonNull(productApiAdapterService);
    }

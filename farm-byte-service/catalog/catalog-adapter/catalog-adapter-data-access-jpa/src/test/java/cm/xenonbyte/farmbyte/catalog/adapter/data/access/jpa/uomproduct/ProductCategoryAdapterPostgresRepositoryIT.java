package cm.xenonbyte.farmbyte.catalog.adapter.data.access.jpa.productproduct;

import cm.xenonbyte.farmbyte.adapter.data.access.jpa.config.BaseEntityJpaConfig;
import cm.xenonbyte.farmbyte.catalog.adapter.data.access.jpa.productcategory.ProductCategoryAdapterPostgresRepository;
import cm.xenonbyte.farmbyte.catalog.adapter.data.access.jpa.productcategory.ProductCategoryJpaMapper;
import cm.xenonbyte.farmbyte.catalog.adapter.data.access.jpa.productcategory.ProductCategoryJpaRepository;

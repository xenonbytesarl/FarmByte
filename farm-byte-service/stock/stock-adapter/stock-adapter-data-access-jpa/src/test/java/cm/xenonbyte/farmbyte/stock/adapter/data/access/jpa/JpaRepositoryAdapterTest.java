...
@EntityScan(basePackages = "cm.xenonbyte.farmbyte.stock.adapter.data.access.jpa")
@ComponentScan(basePackages = {"cm.xenonbyte.farmbyte.stock.adapter.data.access.jpa"})
@EnableJpaRepositories(basePackages = "cm.xenonbyte.farmbyte.stock.adapter.data.access.jpa")

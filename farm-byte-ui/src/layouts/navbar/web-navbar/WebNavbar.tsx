...
const WebNavbar = () => {
    ...
    return (
        <div className={`flex flex-row justify-between items-center py-6 px-8 bg-white shadow-lg ${isOpen ? 'ml-72 transition-all ease-linear duration-300' : 'ml-24 transition-all ease-linear duration-300'}`}>

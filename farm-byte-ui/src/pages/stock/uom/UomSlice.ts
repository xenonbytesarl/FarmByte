...
import uomService from "@/pages/stock/uom/UomService.ts";
...
export const getPageSize = (state: RootState) => state.stock.uom.pageSize;
export const getTotalElements = (state: RootState) => state.stock.uom.totalElements;
export const getTotalPages = (state: RootState) => state.stock.uom.totalPages;
export const getMessage = (state: RootState) => state.stock.uom.message;
export const getError = (state: RootState) => state.stock.uom.error;
export const getLoading = (state: RootState) => state.stock.uom.loading;
...
} = uomAdapter.getSelectors((state: RootState) => state.stock.uom);

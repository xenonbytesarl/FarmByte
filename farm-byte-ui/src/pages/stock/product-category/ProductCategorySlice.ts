...
import productCategoryService from "@/pages/stock/product-category/ProductCategroyService.ts";
...
export const getPageSize = (state: RootState) => state.stock.productCategory.pageSize;
export const getTotalElements = (state: RootState) => state.stock.productCategory.totalElements;
export const getTotalPages = (state: RootState) => state.stock.productCategory.totalPages;
export const getMessage = (state: RootState) => state.stock.productCategory.message;
export const getError = (state: RootState) => state.stock.productCategory.error;
export const getLoading = (state: RootState) => state.stock.productCategory.loading;
...
} = productCategoryAdapter.getSelectors((state: RootState) => state.stock.productCategory);
